            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group position-relative">
                                <input type="password" name="password" id="InputForPassword" placeholder="Masukan Password" class="form-control">
                            ...
                            <div class="form-group position-relative">
                                <input type="password" name="re_pass" id="re_pass" placeholder="Ulangi Password" class="form-control">
                                <!-- Ikon mata yang dapat diklik -->
                    ...
                    <div class="signup-image">
                        <figure><img src="images/signup-bg.jpg" alt="sign up image"></figure>
                    </div>
                </div>
            </div>
        </section>
